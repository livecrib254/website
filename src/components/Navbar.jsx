...
export default function Navbar() {
  ...
  return (
    <header
      className={`sticky top-0 z-[100] backdrop-blur-md bg-white/70 transition-shadow ${
    ...
    >
      ...
      {/* Mobile menu */}
      <nav
        className={`md:hidden absolute inset-x-0 top-[72px] flex flex-col gap-1 border-b border-line bg-white px-5 pb-5 pt-3.5 shadow-card transition-all ${
